...
const QuestionnairePage = () => {
  ...
  return (
    <div className="flex items-center flex-col flex-grow pt-10">
      ...
      {/* Human Data Question */}
<div className="flex flex-col items-center bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mb-8 w-full max-w-lg">
  <div className="text-xl font-bold mb-2 text-base-content">Does your project include human health data?</div>
...
{/* Use Case Question */}
<div className="flex flex-col items-center bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mb-8 w-full max-w-lg">
  <div className="text-xl font-bold mb-2 text-base-content">What is the intended use case for the human health data?</div>
  <div className="flex w-full items-center justify-between">
    <div className="flex flex-col w-full">
      <label className="flex items-center">
        <input
          ...
          className="mr-2"
        />
        <span className="text-base-content">Research</span>
      </label>
      <label className="flex items-center">
        <input
          type="checkbox"
          ...
          className="mr-2"
        />
        <span className="text-base-content">Patient Care</span>
      </label>
      <label className="flex items-center">
        <input
          type="checkbox"
          ...
          className="mr-2"
        />
        <span className="text-base-content">Product Development</span>
      </label>
      <label className="flex items-center">
        <input
          type="checkbox"
          value="Personalized Medicine"
          checked={useCase.includes('Personalized Medicine')}
          onChange={() => handleUseCaseChange('Personalized Medicine')}
          className="mr-2"
        />
        <span className="text-base-content">Personalized Medicine</span>
      </label>
      <label className="flex items-center">
        <input
          type="checkbox"
          value="Global Wellness Initiatives"
          checked={useCase.includes('Global Wellness Initiatives')}
          onChange={() => handleUseCaseChange('Global Wellness Initiatives')}
          className="mr-2"
        />
        <span className="text-base-content">Global Wellness Initiatives</span>
      </label>
      <label className="flex items-center">
        <input
          type="checkbox"
          value="Data Monetization"
          checked={useCase.includes('Data Monetization')}
          onChange={() => handleUseCaseChange('Data Monetization')}
          className="mr-2"
        />
        <span className="text-base-content">Data Monetization</span>
      </label>
      <label className="flex items-center">
        <input
          type="checkbox"
          value="Healthcare DAO Governance"
          checked={useCase.includes('Healthcare DAO Governance')}
          onChange={() => handleUseCaseChange('Healthcare DAO Governance')}
          className="mr-2"
        />
        <span className="text-base-content">Healthcare DAO Governance</span>
      </label>
      <label className="flex items-center">
        <input
          type="checkbox"
          value="Preventative Health"
          checked={useCase.includes('Preventative Health')}
          onChange={() => handleUseCaseChange('Preventative Health')}
          className="mr-2"
        />
        <span className="text-base-content">Preventative Health</span>
      </label>
      <label className="flex items-center">
        <input
          type="checkbox"
          ...
          className="mr-2"
        />
        <span className="text-base-content">Other</span>
        <input
          type="text"
...
<div className="flex flex-col items-center bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mb-8 w-full max-w-lg">
  <div className="text-xl font-bold mb-2 text-base-content">Will the human health data be shared with third parties?</div>
  <div className="flex w-full items-center justify-between">
    <label>
      <input
        type="radio"
...
<div className="flex flex-col items-center bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mb-8 w-full max-w-lg">
  <div className="text-xl font-bold mb-2 text-base-content">Will your human health data project operate in multiple jurisdictions?</div>
  <div className="flex w-full items-center justify-between">
    <label>
      <input
        type="radio"
    ...
    <button className="btn btn-secondary ml-2" onClick={() => setShowPopup5(true)}>Help</button>
  </div>
</div>

{/* Compliance Proof */}
<div className="flex flex-col items-center bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mb-8 w-full max-w-lg">
  <div className="text-xl font-bold mb-2 text-base-content">Do you have a mechanism for demonstrating proof of compliance with relevant regulations?</div>
  <div className="flex w-full items-center justify-between">
    <label className="flex items-center">
      <input
        type="radio"
    ...
    <button className="btn btn-secondary ml-2" onClick={() => setShowPopup6(true)}>Help</button>
  </div>
</div>

{/* Data Retention */}
<div className="flex flex-col items-center bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mb-8 w-full max-w-lg">
  <div className="text-xl font-bold mb-2 text-base-content">Are you required to retain data for a period of time?</div>
  <div className="flex w-full items-center justify-between">
    <label className="flex items-center">
      <input
        type="radio"
    ...
    <button className="btn btn-secondary ml-2" onClick={() => setShowPopup7(true)}>Help</button>
  </div>
</div>

{/* Automate Business Processes */}
<div className="flex flex-col items-center bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mb-8 w-full max-w-lg">
  <div className="text-xl font-bold mb-2 text-base-content">Have you automated the standard business processes used in the human health data industry?</div>
  <div className="flex w-full items-center justify-between">
    <label className="flex items-center">
      <input
        type="radio"
    ...
    <button className="btn btn-secondary ml-2" onClick={() => setShowPopup8(true)}>Help</button>
  </div>
</div>
